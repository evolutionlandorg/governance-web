...
export function convertFixedAmountFromRawNumber(value, decimals = 18, fixedDecimals = 2) {
  const convertAmount = convertAmountFromRawNumber(value, decimals);
  const result = formatFixedDecimals(convertAmount, fixedDecimals);
  return result;
}
