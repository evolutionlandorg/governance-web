...
export default {
  ...
  data: () => {
    return {
      power: new BigNumber(12342.68),
      proposals: [
        {
          id: "001",
          title: "Test poll with link Test poll with link Test poll with link, Test poll with link Test poll with link Test poll with link, Test poll with link Test poll with link Test poll with link",
